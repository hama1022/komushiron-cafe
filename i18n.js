(function () {
  const t = {
    ja: {
      ...
      // takeout
      'takeout.title': 'テイクアウトメニュー',
      'takeout.desc': 'お電話でご注文いただけます。TEL 0964-46-3665',
      'takeout.note': '※価格は税込です。お電話にてご注文ください。TEL 0964-46-3665',
      'to.rice.chicken': 'チキン南蛮プレート', 'to.rice.turkey': 'トルコライス',
      'to.rice.karaage': '塩からあげプレート', 'to.rice.karaage.note': '全てサラダ付　ごはん大盛 +¥150',
      'to.snack.set': 'おつまみセット', 'to.snack.set.items': 'なんこつ唐揚げ・粗びきソーセージ・トリュフ香るポテトフライ',
      'to.snack.potato': 'ポテトフライ トリュフ味',
      'to.pizza.margherita': 'マルゲリータ', 'to.pizza.mix': 'ピザミックス', 'to.pizza.tuna': 'ツナコーンマヨピザ', 'to.pizza.quattro': 'クワトロフォルマッジ', 'to.pizza.price': '各 ¥1,400',
      'to.pasta.nasu-komushiron': '茄子入りコムシロンパスタ', 'to.pasta.tarako-mayo': 'たらこ炙りマヨパスタ', 'to.pasta.tarako-cream': 'タラコクリームパスタ', 'to.pasta.price1': '各 ¥1,100',
      'to.pasta.arabbiata': '激辛アラビアータ', 'to.pasta.meat': 'ナス入りミートソース',
      'to.pasta.nasu-bacon': 'ナスとベーコンのトマトパスタ', 'to.pasta.ebi-kaibashira': 'エビと貝柱のペペロンチーノ',
      'to.pasta.kinoko-bacon': 'キノコとベーコンのペペロンチーノ', 'to.pasta.spinach': 'ほうれん草とベーコンのクリームパスタ', 'to.pasta.price2': '各 ¥1,300',
      'to.pasta.horse': '馬スジのラグーパスタ', 'to.pasta.ebi-kinoko': 'エビとキノコのトマトクリームパスタ', 'to.pasta.price3': '各 ¥1,500',
      'to.pasta.option': 'ミニサラダ付 +¥300　パスタ大盛 +¥500',
      'to.sweets.cake': 'ケーキ各種', 'to.sweets.caramel': 'キャラメルパウンド', 'to.sweets.fruit': 'フルーツパウンド',
    },
    ...
    en: {
      ...
      // takeout
      'takeout.title': 'Takeout Menu',
      'takeout.desc': 'Order by phone. TEL 0964-46-3665',
      'takeout.note': '※ All prices include tax. Please order by phone. TEL 0964-46-3665',
      'to.rice.chicken': 'Chicken Nanban Plate', 'to.rice.turkey': 'Turkish Rice',
      'to.rice.karaage': 'Salt-seasoned Fried Chicken Plate', 'to.rice.karaage.note': 'All include salad. Extra rice +¥150',
      'to.snack.set': 'Snack Set', 'to.snack.set.items': 'Cartilage Karaage · Coarse Sausage · Truffle Fries',
      'to.snack.potato': 'French Fries (Truffle)',
      'to.pizza.margherita': 'Margherita', 'to.pizza.mix': 'Pizza Mix', 'to.pizza.tuna': 'Tuna Corn Mayo Pizza', 'to.pizza.quattro': 'Quattro Formaggi', 'to.pizza.price': '¥1,400 each',
      'to.pasta.nasu-komushiron': 'Eggplant Komushiron Pasta', 'to.pasta.tarako-mayo': 'Seared Tarako Mayo Pasta', 'to.pasta.tarako-cream': 'Tarako Cream Pasta', 'to.pasta.price1': '¥1,100 each',
      'to.pasta.arabbiata': 'Spicy Arrabbiata', 'to.pasta.meat': 'Eggplant Meat Sauce Pasta',
      'to.pasta.nasu-bacon': 'Eggplant & Bacon Tomato Pasta', 'to.pasta.ebi-kaibashira': 'Shrimp & Scallop Peperoncino',
      'to.pasta.kinoko-bacon': 'Mushroom & Bacon Peperoncino', 'to.pasta.spinach': 'Spinach & Bacon Cream Pasta', 'to.pasta.price2': '¥1,300 each',
      'to.pasta.horse': 'Horse Sinew Ragù Pasta', 'to.pasta.ebi-kinoko': 'Shrimp & Mushroom Tomato Cream Pasta', 'to.pasta.price3': '¥1,500 each',
      'to.pasta.option': 'Mini Salad +¥300 · Extra Pasta +¥500',
      'to.sweets.cake': 'Assorted Cakes', 'to.sweets.caramel': 'Caramel Pound Cake', 'to.sweets.fruit': 'Fruit Pound Cake',
    },
    ...
    'zh-TW': {
      ...
      // takeout
      'takeout.title': '外帶菜單',
      'takeout.desc': '請來電點餐。TEL 0964-46-3665',
      'takeout.note': '※ 價格含稅。請來電點餐。TEL 0964-46-3665',
      'to.rice.chicken': '南蠻雞排套餐', 'to.rice.turkey': '土耳其飯',
      'to.rice.karaage': '鹽味炸雞套餐', 'to.rice.karaage.note': '均附沙拉　白飯加量 +¥150',
      'to.snack.set': '下酒菜套餐', 'to.snack.set.items': '軟骨炸雞・粗磨香腸・松露薯條',
      'to.snack.potato': '松露炸薯條',
      'to.pizza.margherita': '瑪格麗特披薩', 'to.pizza.mix': '綜合披薩', 'to.pizza.tuna': '鮪魚玉米美乃滋披薩', 'to.pizza.quattro': '四種乳酪披薩', 'to.pizza.price': '各 ¥1,400',
      'to.pasta.nasu-komushiron': '茄子コムシロン義大利麵', 'to.pasta.tarako-mayo': '炙烤明太子美乃滋義大利麵', 'to.pasta.tarako-cream': '明太子奶油義大利麵', 'to.pasta.price1': '各 ¥1,100',
      'to.pasta.arabbiata': '超辣番茄辣醬義大利麵', 'to.pasta.meat': '茄子肉醬義大利麵',
      'to.pasta.nasu-bacon': '茄子培根番茄義大利麵', 'to.pasta.ebi-kaibashira': '蝦仁干貝義大利辣麵',
      'to.pasta.kinoko-bacon': '菇類培根義大利辣麵', 'to.pasta.spinach': '菠菜培根奶油義大利麵', 'to.pasta.price2': '各 ¥1,300',
      'to.pasta.horse': '馬筋燉肉義大利麵', 'to.pasta.ebi-kinoko': '蝦仁菇類番茄奶油義大利麵', 'to.pasta.price3': '各 ¥1,500',
      'to.pasta.option': '附迷你沙拉 +¥300　加量義大利麵 +¥500',
      'to.sweets.cake': '各式蛋糕', 'to.sweets.caramel': '焦糖磅蛋糕', 'to.sweets.fruit': '水果磅蛋糕',
    },
    ...
    ko: {
      ...
      // takeout
      'takeout.title': '테이크아웃 메뉴',
      'takeout.desc': '전화로 주문해 주세요. TEL 0964-46-3665',
      'takeout.note': '※ 가격은 세금 포함입니다. 전화로 주문해 주세요. TEL 0964-46-3665',
      'to.rice.chicken': '치킨 남반 플레이트', 'to.rice.turkey': '터키 라이스',
      'to.rice.karaage': '소금 닭튀김 플레이트', 'to.rice.karaage.note': '모두 샐러드 포함　밥 곱배기 +¥150',
      'to.snack.set': '안주 세트', 'to.snack.set.items': '연골 닭튀김・굵은 소시지・트러플 감자튀김',
      'to.snack.potato': '감자튀김 트러플맛',
      'to.pizza.margherita': '마르게리타', 'to.pizza.mix': '피자 믹스', 'to.pizza.tuna': '참치 콘 마요 피자', 'to.pizza.quattro': '콰트로 포르마지', 'to.pizza.price': '각 ¥1,400',
      'to.pasta.nasu-komushiron': '가지 코무시론 파스타', 'to.pasta.tarako-mayo': '구운 명란 마요 파스타', 'to.pasta.tarako-cream': '명란 크림 파스타', 'to.pasta.price1': '각 ¥1,100',
      'to.pasta.arabbiata': '초매운 아라비아타', 'to.pasta.meat': '가지 미트소스 파스타',
      'to.pasta.nasu-bacon': '가지와 베이컨의 토마토 파스타', 'to.pasta.ebi-kaibashira': '새우와 관자의 페페론치노',
      'to.pasta.kinoko-bacon': '버섯과 베이컨의 페페론치노', 'to.pasta.spinach': '시금치와 베이컨의 크림 파스타', 'to.pasta.price2': '각 ¥1,300',
      'to.pasta.horse': '말 힘줄 라구 파스타', 'to.pasta.ebi-kinoko': '새우와 버섯의 토마토 크림 파스타', 'to.pasta.price3': '각 ¥1,500',
      'to.pasta.option': '미니 샐러드 포함 +¥300　파스타 곱배기 +¥500',
      'to.sweets.cake': '케이크 각종', 'to.sweets.caramel': '캐러멜 파운드 케이크', 'to.sweets.fruit': '과일 파운드 케이크',
    }
  };
